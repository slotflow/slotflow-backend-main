...
export class AdminReviewController {
    constructor(
        ...
        this.findAllReviewsOfProvider = this.findAllReviewsOfProvider.bind(this);
    ...
    async findAllReviewsOfProvider(req: Request, res: Response) {
        try {
            ...
            console.log("findAllReviewsOfProvider error : ", error);
            HandleError.handle(error, res);
        }
    }
