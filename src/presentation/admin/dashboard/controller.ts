...
import { fetchBookingsDataUseCase, fetchGraphDataUseCase, fetchProviderDataUseCase, fetchRevenueDataUseCase, fetchSubscriptionDataUseCase, fetchTodaysDataUseCase, fetchUserDataUseCase } from "..";
...
class DashboardController {
    constructor(
        ...
        private fetchRevenueDataUseCase: FetchRevenueDataUseCase,
    ...
    async fetchRevenueStats(req: Request, res: Response, next: NextFunction) {
        try {
            const result = await this.fetchRevenueDataUseCase.execute();
            sendResponse(res, result);
        } catch (error) {
